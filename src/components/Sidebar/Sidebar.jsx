    ...
    return (
        ...
        <div className="sidebar">
            <div className="perfil-usuario">
                ...
                <div className="text-perfil rol-usuario">{ tipoUsuario }</div>
            </div>
            <div className="opciones-sidebar">
                ...
                <Link to="/crear-usuarios">
                    <div className="opcion-sidebar">
                        ...
                        <div className="text-opcion">Nuevo Personal</div>
                    </div>
                </Link>
                ...
                <Link to="administrar-usuarios">
                    <div className="opcion-sidebar">
                        ...
                        <div className="text-opcion">Administrar Personal</div>
                    </div>
                </Link>
                <Link to="/login">
                    <div className="opcion-sidebar">
                        <div className='icon'><GrLogout /></div>
